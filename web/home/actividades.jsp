    ...
    <body>
        ...
        <div class="container">
            ...
            <table class="bordered highlight">
                ...
                <tbody>
                    <tr>
                        <td class="m4 s12">1.Introducción a la gestión de Software.</td>
                        <td class="m6 s12">
                            ...
                            <ul class="collapsible" data-collapsible="accordion">
                                <li>
                                    ...
                                    <div class="collapsible-body">
                                        &emsp;&emsp; •	Computadora.<br>
                                        &emsp;&emsp; •	Open office o Microsoft Ofice .<br>
                            ...
                            <div class="collapsible-header">1.4. Metodología.<br></div>
                                    <div class="collapsible-body">
                                        ...
                                        &emsp;&emsp; •	Exponer los resultados obtenidos.<br>
                                    </div>
                                </li>
                            </ul>
                            ...
                            <div class="collapsible-header">1.5. Cuestionario.<br></div>
                                    <div class="collapsible-body">
                                        ...
                                        &emsp;&emsp; 3.- ¿Que documentos contempla las fases de la gestión de software y muéstralos?.<br>
                                    </div>
                                </li>
                            </ul>
                            ...
                            <div class="collapsible-header">1.6. Evaluación.<br></div>
                                    <div class="collapsible-body">
                                        ...
                                        &emsp;&emsp; •	Presentación de resultados: 3%<br>
                                    </div>
                                </li>
                            </ul>
                            </td>
                    ...
                    <tr>
                        <td class="m4 s12">2.Gestión de calidad (Visita a empresa).</td>
                        <td class="m6 s12">
                            <ul class="collapsible" data-collapsible="accordion">
                                <li>
                            ...
                            <ul class="collapsible" data-collapsible="accordion">
                                <li>
                                    ...
                                    <div class="collapsible-body">
                                        &emsp;&emsp; •	Computadora.<br>
                                        &emsp;&emsp; •	Bizagi, Umbrelo o Dial.<br>
                                        &emsp;&emsp; •	Bibliografías:<br> 
                                        &emsp;&emsp;    Pressman, R. (2010). Ingeniería del Software, un Enfoque Práctico. (7ª Ed.). México: Mc.<br>
                                        &emsp;&emsp;    Graw-Hill. Y Sommerville, I. (2011). Ingeniería de Software. (9ª Ed.). México: Pearson Addison-Wesley.<br> 
                            ...
                            <div class="collapsible-header">2.5. Cuestionario.<br></div>
                                    <div class="collapsible-body">
                                        ...
                                        &emsp;&emsp; 3.- ¿Que herramienta Case utilizaron para plasmar el proceso de negocios?.<br>
                                    </div>
                                </li>
                            </ul>
                            ...
                            <div class="collapsible-header">2.6. Evaluación.<br></div>
                                    <div class="collapsible-body">
                                        ...
                                        &emsp;&emsp; •	Ortografía y redacción:   2%<br>
                                        &emsp;&emsp; •	Presentación de componentes de los procesos de negocio en herramienta CASE: 5%<br>
                                    </div>
                                </li>
                            </ul>
                            </td>
                        ...
                        <td class="m6 s12">
                            ...
                            <div class="collapsible-header">4.4. Metodología.<br></div>
                                    <div class="collapsible-body">
                                        ...
                                        &emsp;&emsp; •	Obtener y especificar los requisitos del componente de negocio seleccionado.<br>
                                        &emsp;&emsp; •	Realizar la obtención de requisitos específicos (funcionales y no funcionales) de un caso práctico, con la aplicación de herramientas CASE, presentando los resultados a través de un informe técnico utilizando diagramas de Casos de Uso y de Actividades.<br>
                                    </div>
                                </li>
                            </ul>
                            ...
                            <div class="collapsible-header">4.6. Evaluación.<br></div>
                                    <div class="collapsible-body">
                                        ...
                                        &emsp;&emsp; •  Presentación de resultados en los diagramas de Casos de uso y de actividades: 5%<br>
                                    </div>
                                </li>
                            </ul>
                            </td>
                        ...
                        <td class="m6 s12">
                            ...
                            <div class="collapsible-header">5.4. Metodología.<br></div>
                                    <div class="collapsible-body">
                                        ...
                                        &emsp;&emsp; •	Elaborar un reporte.<br>
                                    </div>
                                </li>
                            </ul>
                        ...
                        <td class="m6 s12">
                            ...
                            <div class="collapsible-header">6.4. Metodología.<br></div>
                                    <div class="collapsible-body">
                                        ...
                                        &emsp;&emsp; •	Elaborar los casos de uso y plasmarlos en un diagrama.<br>
                                        &emsp;&emsp; •	Elaborar la documentación de los casos de uso.<br>
                                        &emsp;&emsp; •  Elaborar el modelo de dominio del sistema.<br>
                                    </div>
                                </li>
                            </ul>
                            ...
                            <div class="collapsible-header">6.5. Cuestionario.<br></div>
                                    <div class="collapsible-body">
                                        ...
                                        &emsp;&emsp; 3.- Todos los diagramas interpretan lo que el cliente desea que realice el sistema y la interpretación es correcta. Justificar las tres respuestas.<br>  
                                    </div>
                                </li>
                            </ul>
