...
insert  into `persona`(`Id_persona`,`nombre_persona`,`apellidopaterno`,`apellidomaterno`) values (3,'Edgar David','Hernandez','Garcia'),(4,'Jair','Barcenas','Gomez'),(5,'Reynaldo','Ramirez','Hernandez'),(6,'Cesar Axahid ','Del Angel ','Cervantes'),(7,'Jonathan','XXX','YYY'),(8,'Claudio','Del Angel','Cruz'),(9,'Erick Clair ','Angel','Martinez'),(10,'Guadalupe','Chavez','Francisco'),(11,'Maria','Hernandez','Gonzalez'),(12,'Jacqueline','Hernandez','Morales'),(20,'Luci','Martinez','Vicencio'),(22,'Lucina','Morales','Ortiz'),(23,'Manuel','Perez','Ramos');
...
insert  into `usuario`(`Id_usuario`,`correo`,`password`,`Id_persona`,`id_tipouser`) values (5,'reynaldo12@gmail.com','4',5,2),(6,'luc@hotmail.com','lucina456',22,1),(7,'Manuel@hotmail.com','manuelPerez9875',23,2);
